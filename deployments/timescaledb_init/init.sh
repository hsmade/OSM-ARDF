...
PGPASSWORD=$POSTGRES_PASSWORD psql -h "timescaledb" -U "postgres" -c "create table doppler (time TIMESTAMPTZ not null default now(), name text not null, lat real not null, lon real not null, bearing INT);"
